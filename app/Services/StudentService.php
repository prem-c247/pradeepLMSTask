...
{
    /**
     * getStudents: Get the all students along with details
     * Can apply multiple filter like (name, email, phone, status)
     *
     * @param  mixed $request
     * @return void
     */
    function getStudents(array $request)
    {
        try {
            ...
            return response200(__('message.server_error', ['name' => __('message.student')]), $e->getMessage());
        }
    }
    ...
    /**
     * updateStudent: Update student details by their ID
     *
     * @param  mixed $request
     * @param  mixed $studentId
     * @return void
     */
    public function updateStudent(object $request, int $studentId)
    {
        try {
    ...
    /**
     * deleteStudent: Delete student by their ID
     *
     * @param  int $studentId
     * @return void
     */
