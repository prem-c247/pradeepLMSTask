...
class UserModificationService extends BaseService
{
    /**
     * getModificationRequests: Get all user modifications requests
     * NOTE: Admin can see all the requests, School will see their teachers and students requests
     * @return void
     */
    public function getModificationRequests()
    {
        try {
    ...
    /**
     * storeRequestForUserModification: Store the user modification request for the target user by their ID
     * NOTE: Modification request will be added by the admin behalf of their school
     * @param  mixed $request
     * @return void
     */
    public function storeRequestForUserModification(object $request)
    {
        try {
     ...
     * @return void
     */
    public function approvedRequest(int $requestId)
    {
        try {
